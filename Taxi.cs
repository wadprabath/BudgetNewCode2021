...
namespace WindowsFormsApplication3
{
    class Taxi
    {
        ...
        string taxiNo; DateTime lastPaymentDate; string reciptNo; int perDayCharge = 600; int SpPerDayCharge = 600; int minimumDays = 5 ; int phoneBil = 400; int workingDays = 0; int ph20Bill = 200;
        int ph25Bill = 100;
        ...
        public bool getSpecialPaymentCab(TextBox tbCabNo, Label lbSpecial, CheckBox chbSpecial)
        {
            ...
            if (reader.HasRows)
            {
                ...
                lbSpecial.Text = "LKR 600.00 Per Day(Unmark)";
                ...
                //connection.Close();
                MessageBox.Show("This Cab Is a Unmark Cab, you should charge LKR 600.00 per Day and Mobitel Bill Ex- For 15 Days With Phone Bill - LKR 6750.00,  For 30 days with Phone bill 13500. No free Days ");
                return true;
                ...
                if (tempdate.ToString() != "01-01-0001 12:00:00 AM")
                {
                    ...
                    if (tempdate.Year == tempdate.AddDays(1).Year)
                    {
                        if (tempdate.Month == (tempdate.AddDays(1)).Month)//same month
                        {
                            ...
                            dgv.Rows[dgv.RowCount - 1].Cells[2].Value = "600";
                            ...
                            if (dgv.CurrentCell.RowIndex == dgv.RowCount - 1)
                            {
                                ...
                                dgv.Rows[dgv.RowCount - 2].Cells[2].Value = "600";
                        ...
                        if (dr == DialogResult.OK)
                        {
                            ...
                            for (int i = 0; i <= dgv2.RowCount - 1; i++)
                            {
                                ...
                                if (dgv2.Rows[i].Cells[3].Value.Equals(((char)254).ToString()))
                                {
                                    ...
                                    if (chb2.Checked == true)// branded car free of charge
                                        command.CommandText = "INSERT INTO TestPayment (CabNo,RecNo,Date,Amount,Cancel,NightFlag,Location,SpFlag) VALUES ('" + taxiNumber + "' ,'" + tbRecNo.Text + "','" + date + "','600','" + flag + "','" + nightFlag + "','" + location + "','" + spFlag + "') ";
                                    else
